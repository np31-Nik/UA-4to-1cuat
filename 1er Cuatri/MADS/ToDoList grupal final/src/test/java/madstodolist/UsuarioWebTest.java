...
public class UsuarioWebTest {
    ...
    @Test
    public void registrarSinAdmin() throws Exception {
        this.mockMvc.perform(get("/registro"))
                .andExpect(content().string(containsString("Usuario Administrador")));
    }

    @Test
    public void registrarConAdmin() throws Exception {
        when(usuarioService.existeAdmin()).thenReturn(true);

        this.mockMvc.perform(get("/registro"))
                .andExpect(content().string(not(containsString("Usuario Administrador"))));
    }

    @Test
    public void loginUsuarioBloqueado() throws Exception{
        // GIVEN
        // Moqueamos la llamada a usuarioService.login para que
        // devuelva un LOGIN_OK y la llamada a usuarioServicie.findByEmail
        // para que devuelva un usuario determinado.
        ...
        // WHEN, THEN
        // Realizamos una petición POST al login pasando los datos
        // esperados en el mock, la petición devolverá error 403
